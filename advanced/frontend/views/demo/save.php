    ...
    <div class="search-box">
        <form action="<?php echo Url::to(['demo/add_do'])?>" method="post">
            <ul>
                <li>
                    <span>请输入字段名称：</span>
                    <input class="filed-name" name="username" value="<?php echo $arr['username']?>" type="text">
                </li>
                <li>
                    <span>请输入字段默认值：</span>
                    <input class="filed-name" name="option" value="<?php echo $arr['option']?>" type="text">
                </li>
                <li>
                    <span>请选择字段类型：</span>
                    <select name="typep">
                ...
                <li>
                    <span>请填写字段选项：</span>
                    <input type="text" name="verify" class="filed-name"  placeholder="选项1">
                    <input type="text" name="verify" class="filed-name"  placeholder="选项2">
                </li>
                <li>
                    <span>是否必填：</span>
                    <input type="checkbox" name="must">必填
                </li>
                <li>
                    <span>请选择验证规则：</span>
                    <select name="rule" id="">
                ...
                <li>
                    <span>请选择填写长度范围：</span>
                    <input class="length" type="text"  name="lenght1"  value="<?php echo  $arr['lenght1']?>" placeholder="请输入最小长度">
                    ~
                    <input class="length" type="text"   name="lenght2" value="<?php echo $arr['lenght2']?>" placeholder="请输入最大长度">
                </li>
                <li>
