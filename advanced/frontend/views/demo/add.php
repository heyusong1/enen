    ...
    <div class="search-box">
     <form action="<?php echo Url::to(['demo/add_do'])?>" method="post">
            <ul>
                <li>
                    <span>请输入字段名称：</span>
                    <input class="filed-name" name="username" type="text">
                </li>
                <li>
                    <span>请输入字段默认值：</span>
                    <input class="filed-name" name="option" type="text">
                </li>
                <li>
                    <span>请选择字段类型：</span>
                    <select name="typep">
                ...
                <li>
                    <span>请选择填写长度范围：</span>
                    <input class="length" type="text"  name="lenght1" value="" placeholder="请输入最小长度">
                    ~
                    <input class="length" type="text"  name="lenght2" value="" placeholder="请输入最大长度">
                </li>
                <li>
